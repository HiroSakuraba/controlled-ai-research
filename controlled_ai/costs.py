...
RATES = {'gpt-5.6-luna': Rate(.20,1.20), 'gpt-5.6-terra': Rate(2,12), 'gpt-5.6-sol': Rate(4,20), 'claude-haiku-4.5': Rate(1,5), 'claude-sonnet-5': Rate(2,10), 'claude-opus-5': Rate(5,25), 'grok-4.6': Rate(2,6)}
